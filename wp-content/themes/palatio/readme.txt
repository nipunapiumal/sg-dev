...
WordPress version: required at least 5.0, tested up to 6.4.1
...
Please install and activate it before starting to use the theme Palatio.
...
Theme documentation is available on https://doc.themerex.net/palatio/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Palatio is Fontello.
