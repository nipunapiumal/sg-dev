...
if ( ! function_exists( 'palatio_gutenberg_get_css' ) ) {
	add_filter( 'palatio_filter_get_css', 'palatio_gutenberg_get_css', 10, 2 );
	function palatio_gutenberg_get_css( $css, $args ) {
