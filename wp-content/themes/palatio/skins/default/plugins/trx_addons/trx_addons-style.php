...
if ( ! function_exists( 'palatio_trx_addons_get_css' ) ) {
	add_filter( 'palatio_filter_get_css', 'palatio_trx_addons_get_css', 10, 2 );
	function palatio_trx_addons_get_css( $css, $args ) {
...
.audio_now_playing, .sc_item_subtitle,
