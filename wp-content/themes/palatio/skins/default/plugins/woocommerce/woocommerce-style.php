...
if ( ! function_exists( 'palatio_woocommerce_get_css' ) ) {
	add_filter( 'palatio_filter_get_css', 'palatio_woocommerce_get_css', 10, 2 );
	function palatio_woocommerce_get_css( $css, $args ) {
...
.shop_table_checkout_review table .variation,
.woocommerce-error,
.woocommerce-info,
.woocommerce-message,
...
$fdir = palatio_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
