...
if ( ! function_exists( 'palatio_tribe_events_get_css' ) ) {
	add_filter( 'palatio_filter_get_css', 'palatio_tribe_events_get_css', 10, 2 );
	function palatio_tribe_events_get_css( $css, $args ) {
...
.tribe-events .tribe-common-b3.tribe-events-calendar-month-mobile-events__mobile-event-cost,
