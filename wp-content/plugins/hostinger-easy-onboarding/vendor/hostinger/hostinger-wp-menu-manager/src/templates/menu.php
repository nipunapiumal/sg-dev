                ...
                <?php if (!empty($api_token)) { ?>
                    <div class="hts-hpanel">
                        <a href="<?php echo esc_url($utils->getHpanelDomainUrl()); ?>" target="_blank" rel="noopener">
                            <?php
                            /* translators: Navbar link label; opens the Hostinger control panel in a new tab.
                               Keep "Hostinger" as the brand name, and word the phrase naturally. */
                            echo esc_html__('Hostinger dashboard', 'hostinger-wp-menu-package');
                            ?>
                        </a>
