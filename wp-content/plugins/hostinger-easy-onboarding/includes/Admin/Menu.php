...
class Menu {
    ...
    public function add_admin_bar_items( array $menu_items ): array {
        $menu_items[] = array(
            ...
            'title' => esc_html__( 'Hub', 'hostinger-easy-onboarding' ),
    ...
    public function add_hpanel_bar_items( array $menu_items ): array {
        ...
        $menu_items[] = array(
            ...
            'title' => esc_html__( 'Hostinger dashboard - Home', 'hostinger-easy-onboarding' ) . $external_icon,
        ...
        $menu_items[] = array(
            ...
            'title' => esc_html__( 'Hostinger dashboard - Websites', 'hostinger-easy-onboarding' ) . $external_icon,
        ...
        $menu_items[] = array(
            ...
            'title' => esc_html__( 'Hostinger dashboard - Billing', 'hostinger-easy-onboarding' ) . $external_icon,
    ...
    public function add_menu_sub_pages( array $submenus ): array {
        $submenus[] = array(
            'page_title'      => __( 'Hub', 'hostinger-easy-onboarding' ),
            'menu_title'      => __( 'Hub', 'hostinger-easy-onboarding' ),
