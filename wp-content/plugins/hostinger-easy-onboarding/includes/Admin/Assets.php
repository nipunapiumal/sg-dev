        ...
        if ( $this->is_onboarding_admin_page() ) {
            ...
            $localize_data = array(
                ...
                'translations'            => array(
                    ...
                    'hostinger_easy_onboarding_hub_footer_title'                                     => __( 'Hostinger Hub', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hub_footer_version'                                   => __( 'Version', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hub_footer_academy'                                   => __( 'Hostinger Academy', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hub_footer_wp_tutorials'                              => __( 'WP tutorials', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_hub_footer_knowledge_base'                            => __( 'Knowledge base', 'hostinger-easy-onboarding' ),
                    ...
                    'hostinger_easy_onboarding_hub_dismiss_suggestion'                               => __( 'Dismiss suggestion', 'hostinger-easy-onboarding' ),
                    ...
                    'hostinger_easy_onboarding_update'                                               => __( 'update', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_updates'                                              => __( 'updates', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_up_to_date'                                           => __( 'Up to date', 'hostinger-easy-onboarding' ),
                ...
                'active_plugins_v2'       => array_values(
                    array_map(
                        function ( $plugin ) use ( $all_plugins, $plugin_updates ) {
                            return array(
                                'name'                => $plugin,
                                'slug'                => dirname( $plugin ),
                ...
                'plugin_version'          => HOSTINGER_EASY_ONBOARDING_VERSION,
            );
