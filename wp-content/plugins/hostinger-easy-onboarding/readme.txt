...
- Fix: Remove MCP connector banner
- Feature: Translations
- Feature: Hub page
- Fix: Hub CTA borders
- Fix: Duplicate plan CTA
- Fix: Hub stale data
- Fix: Hub plural update label
- Fix: Renamed the hPanel admin bar links to "Hostinger dashboard"
- Tweak: Adjust MCP Connector banner text color
- Fix: Hub theme version
- Fix: Hub resources formatting
- Feature: Hub hide notifications
- Feature: Hub Footer component
- Fix: Update translations

2.1.38 (2026-09-08)

- Tweak: Add MCP Connector Banner
