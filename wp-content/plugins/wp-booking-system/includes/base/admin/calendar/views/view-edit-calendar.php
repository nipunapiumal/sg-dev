...
<div class="wrap wpbs-wrap wpbs-wrap-edit-calendar">
	...
	<form method="POST" action="" autocomplete="off">
				...
				<div id="postbox-container-1" class="postbox-container">
					...
					<!-- Calendar Legend -->
		 			<div class="postbox">
						...
						<div class="wpbs-plugin-card-bottom plugin-card-bottom">
							<a class="button-secondary" href="<?php echo add_query_arg(array('page' => 'wpbs-calendars', 'calendar_id' => $calendar->get('id'), 'subpage' => 'view-legend'), admin_url( 'admin.php' )); ?>"><?php echo __('Edit Legend Items', 'wp-booking-system'); ?></a>
						</div>
					...
					<div class="postbox">
						...
						<div class="inside">
							...
							<a href="<?php echo add_query_arg(array('page' => 'wpbs-calendars', 'calendar_id' => $calendar->get('id'), 'subpage' => 'ical-import-export'), admin_url( 'admin.php' )); ?>" class="button-secondary"><?php echo __('iCal Import/Export', 'wp-booking-system'); ?></a>
		...
		<!-- Nonce -->
		<?php wp_nonce_field( 'wpbs_save_calendar', 'wpbs_token', false ); ?>
