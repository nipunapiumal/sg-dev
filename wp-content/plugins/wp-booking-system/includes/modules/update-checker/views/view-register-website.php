...
<div id="wpbs-wpbs-settings-field-register-website" class="wpbs-settings-field-wrapper wpbs-settings-field-inline">
	...
	<div class="wpbs-settings-field-inner">
		...
		<?php if( empty( $website_id ) ): ?>
			<a id="wpbs-register-website-button" class="button-primary" href="<?php echo add_query_arg( array( 'tab' => 'register_website', 'wpbs_action' => 'register_website', 'wpbs_token' => wp_create_nonce( 'wpbs_register_website' ) ), admin_url( 'admin.php' ) ); ?>"><?php echo __( 'Register Website', 'wp-booking-system' ); ?></a>
		<?php else: ?>
			<a id="wpbs-deregister-website-button" class="button-secondary" href="<?php echo add_query_arg( array( 'tab' => 'register_website', 'wpbs_action' => 'deregister_website', 'wpbs_token' => wp_create_nonce( 'wpbs_deregister_website' ) ), admin_url( 'admin.php' ) ); ?>"><?php echo __( 'Deregister Website', 'wp-booking-system' ); ?></a>
		<?php endif; ?>
...
<div id="wpbs-wpbs-settings-field-register-website" class="wpbs-settings-field-wrapper wpbs-settings-field-inline">
	...
	<div class="wpbs-settings-field-inner">
		...
		<a id="wpbs-check-for-updates-button" class="button-secondary" <?php echo ( empty( $serial_key ) || empty( $website_id ) ? 'disabled' : '' ); ?> href="<?php echo add_query_arg( array( 'tab' => 'register_website', 'wpbs_action' => 'check_for_updates', 'wpbs_token' => wp_create_nonce( 'wpbs_check_for_updates' ) ), admin_url( 'admin.php' ) ); ?>"><?php echo __( 'Check for Updates', 'wp-booking-system' ); ?></a>
