	...
	function trx_addons_init_options() {
		...
		$TRX_ADDONS_STORAGE['options'] = apply_filters( 'trx_addons_filter_options', array_merge(
			...
			array(
				...
				'general_info' => array(
					"title" => esc_html__('General Settings', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_general' ),
			...
			array(
				"allow_presets_for_elementor_editor" => array(
					"title" => esc_html__('Allow Presets in Elementor Editor', 'trx_addons'),
					"desc" => wp_kses_data( __('Add a section "Preset" to the bottom of the tab "Advanced" for each Elementor widget to remember all styling settings as a preset and then apply it to another instances of the widget', 'trx_addons')
										. '<br>'
										. __('.', 'trx_addons')
										),
					"std" => "1",
				...
				'add_target_blank_own' => array(
					"title" => esc_html__("Open plugin's external links in a new window", 'trx_addons'),
					"desc" => wp_kses_data( __('Add the attribute target="_blank" to all links whose URL leads outside this site when generating the page on the server (only for links generated by the plugin).', 'trx_addons') ),
					"std" => "1",
					"type" => "switch"
				),
				'add_target_blank' => array(
					"title" => esc_html__('Open all external links in a new window', 'trx_addons'),
					"desc" => wp_kses_data( __('Each time a page is loaded, use JavaScript to add the attribute target="_blank" to all links on the page whose URLs lead outside of this site (for all links on the page, regardless of which plugin generated them).', 'trx_addons') ),
					"std" => "0",
					"type" => "switch"
				),
			),
			...
			array(
				...
				'preloader_info' => array(
					"title" => esc_html__('Preloader', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_preloader' ),
				...
				'scroll_info' => array(
					"title" => esc_html__('Scroll helpers', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_scroll_helpers' ),
				...
				'hide_fixed_rows' => array(
					...
					"std" => "0",	//apply_filters( 'trx_addons_filter_allow_sc_styles_in_elementor', false, 'hide_fixed_rows' ) ? "0" : "1",
					"type" => "switch"
				),
				'smooth_scroll' => array(
			...
			array(
				...
				'menu_info' => array(
					"title" => esc_html__('Menu', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_menu_and_search' ),
			...
			array(
				...
				'performance_info' => array(
					"title" => esc_html__('General Settings', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_performance' ),
...
*/
				...
				'remove_attribute_type' => array(
					"title" => esc_html__('Remove attribute "type" from scripts and styles', 'trx_addons'),
					"desc" => wp_kses_data( __('Remove the attribute type="text/javascript" from tags <script> and type="text/css" from tags <style> as unnecessary to prevent warnings in W3C Validators', 'trx_addons') ),
					"std" => "1",
					"type" => "switch"
				),
				...
				'cache_info' => array(
					"title" => esc_html__('Cache manager', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_cache_manager' ),
			...
			array(
				...
				'api_google_info' => array(
					"title" => esc_html__('Google Maps API', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_google' ),
			...
			array(
				...
				'api_openstreet_info' => array(
					"title" => esc_html__('OpenStreetMap API', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_openstreetmap' ),
			...
			array(
				...
				'api_fb_info' => array(
					"title" => esc_html__('Facebook API', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_facebook' ),
			...
			array(
				...
				'api_instagram_info' => array(
					"title" => esc_html__('Instagram API', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_instagram' ),
			...
			array(
				...
				'login_info' => array(
					"title" => esc_html__('Login and Registration', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_users' ),
			...
			array(
				...
				'socials_info' => array(
					"title" => esc_html__('Links to your social profiles', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_socials' ),
			...
			array(
				...
				'share_info' => array(
					"title" => esc_html__('URL to share posts', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_share_posts' ),
			...
			array(
				...
				'emotions_info' => array(
					"title" => esc_html__('Emotions', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_emotions' ),
			...
			array(
				'sc_anchor_info' => array(
					"title" => esc_html__('Anchor', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_shortcodes' ),
			...
			array(
				'columns_info' => array(
					"title" => esc_html__('Columns Grid', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_theme_columns_grid' ),
			...
			// Theme specific - Theme wrappers
			array(
				'wrappers_info' => array(
					"title" => esc_html__('Page wrappers', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_theme_wrappers' ),
				...
				'page_wrap_class' => array(
					...
					"desc" => wp_kses_data( __("Specify a theme-specific selector for the entire page wrapper (contains all of the page components).", 'trx_addons') ),
					"std" => '.page_wrap',
					"type" => "text"
				),
				'header_wrap_class' => array(
					"title" => esc_html__("Header wrap class", 'trx_addons'),
					"desc" => wp_kses_data( __("Specify a theme-specific selector for the page header wrapper (contains the logo, menu, etc.).", 'trx_addons') ),
					"std" => '.top_panel',
					"type" => "text"
				),
				'footer_wrap_class' => array(
					"title" => esc_html__("Footer wrap class", 'trx_addons'),
					"desc" => wp_kses_data( __("Specify a theme-specific selector for the page footer wrapper (contains the contact info, alternative menu, etc.).", 'trx_addons') ),
					"std" => '.footer_wrap',
					"type" => "text"
				),
				'sidebar_wrap_class' => array(
					"title" => esc_html__("Sidebar wrap class", 'trx_addons'),
					"desc" => wp_kses_data( __("Specify a theme-specific selector for the sidebar wrapper (contains the widgets).", 'trx_addons') ),
					"std" => '.sidebar',
					"type" => "text"
				),
			)
...
if ( ! function_exists( 'trx_addons_init_settings' ) ) {
	...
	function trx_addons_init_settings() {
		...
		$TRX_ADDONS_STORAGE['settings'] = apply_filters( 'trx_addons_init_settings', array(
			...
			'icons_selector'            => 'internal',              // Type of icons selector: builder|internal
...
if ( ! function_exists( 'trx_addons_init_settings_patch' ) ) {
	add_filter( 'trx_addons_init_settings', 'trx_addons_init_settings_patch', 11 );
	/**
	 * Correct individual plugin's settings for a new themes
	 * 
	 * @hooked trx_addons_init_settings, 11 (to override a theme settings)
	 *
	 * @param array @settings  Array with a plugin settings
	 *
	 * @return array  Modified array with a plugin settings
	 */
	function trx_addons_init_settings_patch( $settings ) {
		if ( apply_filters( 'trx_addons_filter_allow_sc_styles_in_elementor', false, 'settings' ) ) {
			$settings['add_hide_on_xxx'] = 'add';
		}
		return $settings;
	}
}
