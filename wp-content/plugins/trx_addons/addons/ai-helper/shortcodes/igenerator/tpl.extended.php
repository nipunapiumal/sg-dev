...
$stability_ai_version = trx_addons_get_option( 'ai_helper_default_api_stability_ai', 'v1' );
						...
						?><div class="sc_igenerator_form_fields_left"><?php
							...
							?><div class="sc_igenerator_form_field sc_igenerator_form_field_upload_image trx_addons_hidden" data-actions="variations,upscale">
								<div class="sc_igenerator_form_field_inner">
									<label for="sc_igenerator_form_field_upload_image_field<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e( 'Upload image', 'trx_addons' ); ?></label><?php
									if ( $decorated ) {
										?>
							...
							?><div class="sc_igenerator_form_field sc_igenerator_form_field_prompt" data-actions="generation,variations">
								<div class="sc_igenerator_form_field_inner">
									<label for="sc_igenerator_form_field_prompt_text<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e( 'Prompt', 'trx_addons' ); ?></label>
									<input type="text"
						...
						?><div class="sc_igenerator_form_fields_right"><?php
							...
							if ( is_array( $models ) ) {
								?><div class="sc_igenerator_form_field sc_igenerator_form_field_model" data-actions="generation,variations">
									<div class="sc_igenerator_form_field_inner">
										<label for="sc_igenerator_form_field_model<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e( 'Model', 'trx_addons' ); ?></label>
										...
										?>">
											<select name="sc_igenerator_form_field_model" id="sc_igenerator_form_field_model<?php echo esc_attr( $id_suffix ); ?>"><?php
												$group = false;
											...
											if ( ! empty( $args['show_settings'] ) && (int) $args['show_settings'] > 0 ) {
												...
												?><div class="sc_igenerator_form_settings"><?php
													...
													>
														<label for="sc_igenerator_form_settings_field_guidance_scale<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e('Guidance scale:', 'trx_addons'); ?></label>
														<div class="sc_igenerator_form_settings_field_numeric_wrap">
															<input
																type="number"
																name="sc_igenerator_form_settings_field_guidance_scale"
																id="sc_igenerator_form_settings_field_guidance_scale<?php echo esc_attr( $id_suffix ); ?>"
																min="1"
																max="20"
																step="0.1"
													...
													?><div class="sc_igenerator_form_settings_field sc_igenerator_form_settings_field_inference_steps"
														...
														data-models="stable-diffusion"
													>
														<label for="sc_igenerator_form_settings_field_inference_steps<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e('Inference steps:', 'trx_addons'); ?></label>
														<div class="sc_igenerator_form_settings_field_numeric_wrap">
															<input
																type="number"
																name="sc_igenerator_form_settings_field_inference_steps"
																id="sc_igenerator_form_settings_field_inference_steps<?php echo esc_attr( $id_suffix ); ?>"
																min="21"
																max="51"
																step="10"
													...
													if ( $stability_ai_version == 'v1' ) {
														...
														>
															<label for="sc_igenerator_form_settings_field_cfg_scale<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e('Cfg scale:', 'trx_addons'); ?></label>
															<div class="sc_igenerator_form_settings_field_numeric_wrap">
																<input
																	type="number"
																	name="sc_igenerator_form_settings_field_cfg_scale"
																	id="sc_igenerator_form_settings_field_cfg_scale<?php echo esc_attr( $id_suffix ); ?>"
																	min="0"
																	max="35"
																	step="0.1"
														...
														?><div class="sc_igenerator_form_settings_field sc_igenerator_form_settings_field_diffusion_steps"
															...
															data-models="stability-ai"
														>
															<label for="sc_igenerator_form_settings_field_diffusion_steps<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e('Diffusion steps:', 'trx_addons'); ?></label>
															<div class="sc_igenerator_form_settings_field_numeric_wrap">
																<input
																	type="number"
																	name="sc_igenerator_form_settings_field_diffusion_steps"
																	id="sc_igenerator_form_settings_field_diffusion_steps<?php echo esc_attr( $id_suffix ); ?>"
																	min="10"
																	max="150"
																	step="1"
														...
														?><div class="sc_igenerator_form_settings_field sc_igenerator_form_settings_field_strength"
															...
															data-models="stability-ai"
														>
															<label for="sc_igenerator_form_settings_field_strength<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e('Strength:', 'trx_addons'); ?></label>
															<div class="sc_igenerator_form_settings_field_numeric_wrap">
																<input
																	type="number"
																	name="sc_igenerator_form_settings_field_strength"
																	id="sc_igenerator_form_settings_field_strength<?php echo esc_attr( $id_suffix ); ?>"
																	min="0.0"
																	max="1.0"
																	step="0.1"
													...
													>
														<label for="sc_igenerator_form_settings_field_seed<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e('Seed:', 'trx_addons'); ?></label>
														<div class="sc_igenerator_form_settings_field_numeric_wrap">
															<input
																type="number"
																name="sc_igenerator_form_settings_field_seed"
																id="sc_igenerator_form_settings_field_seed<?php echo esc_attr( $id_suffix ); ?>"
																min="0"
																max="4294967295"
																step="1"
																value="0"
							...
							// Style
							if ( is_array( $styles ) ) {
								?><div class="sc_igenerator_form_field sc_igenerator_form_field_style<?php if ( empty( $args['model'] ) || ! Utils::is_stability_ai_model( $args['model'] ) ) echo ' trx_addons_hidden'; ?>" data-actions="generation,variations">
									<div class="sc_igenerator_form_field_inner">
										<label for="sc_igenerator_form_field_style<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e( 'Style', 'trx_addons' ); ?></label>
										<select name="sc_igenerator_form_field_style" id="sc_igenerator_form_field_style<?php echo esc_attr( $id_suffix ); ?>"><?php
							...
							if ( is_array( $styles_openai ) ) {
								?><div class="sc_igenerator_form_field sc_igenerator_form_field_style_openai<?php if ( empty( $args['model'] ) || ! Utils::is_openai_dall_e_3_model( $args['model'] ) ) echo ' trx_addons_hidden'; ?>" data-actions="generation,variations">
									<div class="sc_igenerator_form_field_inner">
										<label for="sc_igenerator_form_field_style_openai<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e( 'Style', 'trx_addons' ); ?></label>
										<select name="sc_igenerator_form_field_style_openai" id="sc_igenerator_form_field_style_openai<?php echo esc_attr( $id_suffix ); ?>"><?php
							...
							?><div class="sc_igenerator_form_field sc_igenerator_form_field_lora_model<?php if ( empty( $args['model'] ) || ! Utils::is_stable_diffusion_model( $args['model'] ) ) echo ' trx_addons_hidden'; ?>" data-actions="generation,variations">
								<div class="sc_igenerator_form_field_inner">
									<label for="sc_igenerator_form_field_lora_model<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e( 'LoRA model[s] (optional)', 'trx_addons' ); ?></label>
									<input type="text"
										name="sc_igenerator_form_field_lora_model"
										id="sc_igenerator_form_field_lora_model<?php echo esc_attr( $id_suffix ); ?>"
										value=""
							...
							if ( is_array( $upscalers ) ) {
								?><div class="sc_igenerator_form_field sc_igenerator_form_field_upscaler" data-actions="upscale">
									<div class="sc_igenerator_form_field_inner">
										<label for="sc_igenerator_form_field_upscaler<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e( 'Model', 'trx_addons' ); ?></label>
										<select name="sc_igenerator_form_field_upscaler" id="sc_igenerator_form_field_upscaler<?php echo esc_attr( $id_suffix ); ?>"><?php
											$i = 0;
							...
							if ( is_array( $sizes ) ) {
								?><div class="sc_igenerator_form_field sc_igenerator_form_field_size" data-actions="generation,variations,upscale"><?php
									...
									?><div class="sc_igenerator_form_field_size_wrap">
										<div class="sc_igenerator_form_field_inner">
											<label for="sc_igenerator_form_field_size<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e( 'Size (px)', 'trx_addons' ); ?></label>
											<select name="sc_igenerator_form_field_size" id="sc_igenerator_form_field_size<?php echo esc_attr( $id_suffix ); ?>"><?php
									...
									?><div class="sc_igenerator_form_field_scale_wrap trx_addons_hidden">
										<div class="sc_igenerator_form_field_inner">
											<label for="sc_igenerator_form_field_scale<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e( 'Scale factor', 'trx_addons' ); ?></label>
											<div class="sc_igenerator_form_field_numeric_wrap">
												<input
													type="number"
													name="sc_igenerator_form_field_scale"
													id="sc_igenerator_form_field_scale<?php echo esc_attr( $id_suffix ); ?>"
													min="2"
													max="4"
													value="2"
												>
									...
									?><div class="sc_igenerator_form_field_dimensions_wrap<?php if ( $args['size'] != 'custom' ) echo ' trx_addons_hidden'; ?>"><?php
										...
										?><div class="sc_igenerator_form_field_width_wrap">
											<div class="sc_igenerator_form_field_inner">
												<label for="sc_igenerator_form_field_width<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e( 'Width', 'trx_addons' ); ?></label>
												<div class="sc_igenerator_form_field_numeric_wrap">
													<input
														type="number"
														name="sc_igenerator_form_field_width"
														id="sc_igenerator_form_field_width<?php echo esc_attr( $id_suffix ); ?>"
														min="0"
										...
										?><div class="sc_igenerator_form_field_height_wrap">
											<div class="sc_igenerator_form_field_inner">
												<label for="sc_igenerator_form_field_height<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e( 'Height', 'trx_addons' ); ?></label>
												<div class="sc_igenerator_form_field_numeric_wrap">
													<input
														type="number"
														name="sc_igenerator_form_field_height"
														id="sc_igenerator_form_field_height<?php echo esc_attr( $id_suffix ); ?>"
														min="0"
