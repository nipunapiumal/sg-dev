...
if ( false && settings.type == 'popup' ) {
	...
	#><div id="{{ id }}" class="<#
		print( trx_addons_apply_filters( 'trx_addons_filter_sc_classes',
										'sc_chat sc_chat_' + settings.type
											+ ( styles_allowed ? ' trx_addons_customizable' : '' )
											+ ( settings.allow_attachments > 0 ? ' sc_chat_with_attachments' : '' ),
										settings
		) );
	#>"><#
		...
		#><div class="sc_chat_content sc_item_content">
			...
			>
				<div class="sc_chat_form_inner">
					...
					// Prompt field
					var trx_addons_ai_helper_prompt_id = 'sc_chat_form_field_prompt_' + trx_addons_get_unique_id();

					#><div class="sc_chat_form_field sc_chat_form_field_prompt">
						<div class="sc_chat_form_field_inner">
							<input id="{{ trx_addons_ai_helper_prompt_id }}" type="text" value="{{ settings.prompt }}" class="sc_chat_form_field_prompt_text"<#
