...
class Url {
	 ...
	 * @return string
	 */
	public static function responsesUrl( string $id = '' ): string {
		return ! empty( $id ) ? self::baseURL( "responses/{$id}" ): self::baseURL( "responses" );
	}

	/**
	 * @return string
	 */
	public static function conversationsUrl( string $id = '' ): string {
		return ! empty( $id ) ? self::baseURL( "conversations/{$id}" ): self::baseURL( "conversations" );
	}
