<?php
/**
 * The style "qw-stylish" of the Services item
 *
...
if ( has_post_thumbnail() ) {
	$image = trx_addons_get_attachment_url(	get_post_thumbnail_id( get_the_ID() ), apply_filters( 'trx_addons_filter_thumb_size', trx_addons_get_thumb_size( $tpl.'-thumb-masonry-big' ), 'qw-services-stylish', $args ) );
}
