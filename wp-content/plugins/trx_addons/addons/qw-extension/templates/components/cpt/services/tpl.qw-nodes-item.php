<?php
/**
 * The style "qw-nodes" of the Services
 *
...
$add_to_cart_link = ! empty( $meta['price'] ) 
						? apply_filters( 'trx_addons_filter_cpt_add_to_cart_link', '', 'sc_services_item_price_link', apply_filters( 'trx_addons_filter_cpt_add_to_cart_label', $meta['price'], 'services-qw-nodes' ) )
						: '';
...
?>><?php
	...
	<div class="sc_services_item_info">
		...
		if ( false && has_post_thumbnail() && (empty($args['featured']) || $args['featured']!='image')) {
			...
			trx_addons_get_template_part('templates/tpl.featured.php',
											...
											apply_filters( 'trx_addons_filter_args_featured', array(
															...
															'no_links' => empty($link),
															'link' => $link,
															'thumb_size' => trx_addons_get_thumb_size( $tpl.'-thumb-big' ),
