	...
	?><div<?php if (!empty($args['id'])) echo ' id="'.esc_attr($args['id']).'"'; ?> class="sc_services sc_services_<?php 
		...
		while ( $query->have_posts() ) { $query->the_post();
			...
			trx_addons_get_template_part(array(
											TRX_ADDONS_PLUGIN_CPT . 'services/tpl.' . trx_addons_esc( trx_addons_sanitize_file_name( $args['type'] ) ) . '-item.php',
                                            TRX_ADDONS_PLUGIN_CPT . 'services/tpl.default-item.php'
                                            ),
                                            'trx_addons_args_item_number',
                                            $trx_addons_number
                                        );
			if ( $args['type'] == 'qw-panel' ) {
		...
		trx_addons_show_layout( $add_html, '<div class="sc_services_qw_panel_thumbs">', '</div>' );
