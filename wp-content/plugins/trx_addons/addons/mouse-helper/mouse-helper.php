	...
	function trx_addons_mouse_helper_add_options( $options ) {
		trx_addons_array_insert_before($options, 'sc_section', apply_filters( 'trx_addons_filter_options_mouse_helper', array(
			...
			'mouse_helper_info' => array(
				"title" => esc_html__('Mouse helper', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_mouse_helper' ),
					...
					$params = array_merge(
								...
								array(
									array(
										...
										'label' => __("Highlight on mouse hover", 'trx_addons') . trx_addons_get_theme_doc_link( '#theme_addons_mouse_helper_highlight' ),
					...
					$params = array_merge(
								...
								array(
									array(
										...
										"heading" => esc_html__("Highlight on mouse hover", 'trx_addons') . trx_addons_get_theme_doc_link( '#theme_addons_mouse_helper_highlight' ),
	...
	function trx_addons_mouse_helper_highlight_add_heading_param_in_elementor( $element, $section_id, $args ) {
		...
		if ( 'heading' == $el_name && 'section_title' === $section_id && (int) trx_addons_get_option('mouse_helper') > 0 ) {
			$element->add_control( 'mouse_helper_highlight', array(
									'type' => \Elementor\Controls_Manager::SWITCHER,
									'label' => __("Highlight on mouse hover", 'trx_addons') . trx_addons_get_theme_doc_link( '#theme_addons_mouse_helper' ),
									'label_on' => __( 'On', 'trx_addons' ),
									'label_off' => __( 'Off', 'trx_addons' ),
									'return_value' => '1',
									'default' => '',
...
if (!function_exists('trx_addons_mouse_helper_add_params_to_elements')) {
	...
	function trx_addons_mouse_helper_add_params_to_elements($element, $section_id, $args) {
		...
		if ( in_array( $element->get_name(), array( 'container', 'section', 'column', 'common', 'common-optimized' ) ) && $section_id == '_section_responsive' && (int) trx_addons_get_option( 'mouse_helper' ) > 0 ) {
			...
			$element->start_controls_section( 'section_trx_mouse_helper', array(
																		...
																		'label' => __( 'Mouse Helper', 'trx_addons' ) . trx_addons_get_theme_doc_link( '#theme_addons_mouse_helper' )
																	) );
...
//				),
			...
			$element->add_control( 'mouse_helper_mode', array(
				...
				'label_block' => false,
				'options' => apply_filters( 'trx_addons_filter_mouse_helper_mode', trx_addons_get_list_blend_modes() ),
				'condition' => array(
					'mouse_helper' => '1',
					'mouse_helper_hide_helper!' => '1'
				),
...
if ( !function_exists( 'trx_addons_mouse_helper_before_render_elements' ) ) {
	...
	add_action( 'elementor/frontend/container/before_render', 'trx_addons_mouse_helper_before_render_elements', 10, 1 );
