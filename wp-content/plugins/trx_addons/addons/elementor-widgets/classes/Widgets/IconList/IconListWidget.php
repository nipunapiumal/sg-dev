...
class IconListWidget extends BaseWidget {
	...
	protected function register_content_list_controls() {
		...
		$this->add_control(
			'text_html_tag',
			array(
				'label'   => __( 'Text HTML Tag', 'trx_addons' ),
	...
	protected function register_style_list_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units'            => [ 'px', '%', 'em', 'rem', 'vw', 'vh', 'custom' ],
				'selectors'             => [
					'{{WRAPPER}} .trx-addons-list-items.trx-addons-inline-items' => 'gap: {{ROW}}{{UNIT}} {{COLUMN}}{{UNIT}};',
					'{{WRAPPER}} .trx-addons-list-items:not(.trx-addons-inline-items) li:not(:last-child)' => 'margin-bottom: {{ROW}}{{UNIT}};',
		...
		$this->add_group_control(
			...
			[
				...
				'selector'              => '{{WRAPPER}} .trx-addons-list-items li.trx-addons-icon-list-item-without-link,
											{{WRAPPER}} .trx-addons-list-items li.trx-addons-icon-list-item-with-link a',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units'            => [ 'px', '%', 'em', 'rem', 'vw', 'vh', 'custom' ],
				'selectors'             => [
					'{{WRAPPER}} .trx-addons-list-items li.trx-addons-icon-list-item-without-link,
					 {{WRAPPER}} .trx-addons-list-items li.trx-addons-icon-list-item-with-link a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'             => [
					'{{WRAPPER}} .trx-addons-list-items li.trx-addons-icon-list-item-without-link,
					 {{WRAPPER}} .trx-addons-list-items li.trx-addons-icon-list-item-with-link a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'                 => __( 'Background', 'trx_addons' ),
				'types'                 => [ 'classic', 'gradient' ],
				'selector'              => '{{WRAPPER}} .trx-addons-list-items li.trx-addons-icon-list-item-without-link:hover,
											{{WRAPPER}} .trx-addons-list-items li.trx-addons-icon-list-item-with-link a:hover',
			]
		);
		...
		$this->add_responsive_control(
			'list_items_border_radius_hover',
			[
				'label'                 => __( 'Border Radius', 'trx_addons' ),
				'type'                  => Controls_Manager::DIMENSIONS,
				'size_units'            => [ 'px', '%', 'em', 'rem', 'vw', 'vh', 'custom' ],
				'selectors'             => [
					'{{WRAPPER}} .trx-addons-list-items li.trx-addons-icon-list-item-without-link:hover,
					 {{WRAPPER}} .trx-addons-list-items li.trx-addons-icon-list-item-with-link a:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);

		$this->add_control(
			'list_items_hover_transition',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .trx-addons-list-items li' => 'transition-duration: {{SIZE}}s',
				],
			]
		);
	...
	protected function register_style_text_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units'            => [ 'px', '%', 'em', 'rem', 'vw', 'vh', 'custom' ],
				'selectors'             => [
					'{{WRAPPER}} .trx-addons-icon-list-text' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'placeholder'           => '1px',
				'default'               => '1px',
				'selector'              => '{{WRAPPER}} .trx-addons-icon-list-item:hover .trx-addons-icon-list-text',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units'            => [ 'px', '%', 'em', 'rem', 'vw', 'vh', 'custom' ],
				'selectors'             => [
					'{{WRAPPER}} .trx-addons-icon-list-item:hover .trx-addons-icon-list-text' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .trx-addons-icon-list-item .trx-addons-icon-list-text' => 'transition-duration: {{SIZE}}s',
				],
			]
		);
	...
	protected function render() {
		...
		$text_tag = TrxAddonsUtils::validate_html_tag( $settings['text_html_tag'] );
				...
				<?php foreach ( $settings['list_items'] as $index => $item ) : ?>
					<?php if ( $item['text'] ) { ?>
							...
							$this->add_render_attribute( [
								$item_key => [
									'class' => [
										...
										'trx-addons-icon-list-item-' . ( '' !== $item['link']['url'] ? 'with-link' : 'without-link' ),
						...
						<li <?php echo wp_kses_post( $this->get_render_attribute_string( $item_key ) ); ?>>
							...
							?>
							<<?php echo esc_html( $text_tag ); ?> <?php echo wp_kses_post( $this->get_render_attribute_string( $text_key ) ); ?>>
			...
			<ul {{{ view.getRenderAttributeString( 'list_items' ) }}}>
				...
				_.each( settings.list_items, function( item, index ) {
					...
					view.addRenderAttribute( itemKey, {
						'class': [
							'trx-addons-icon-list-item',
							'trx-addons-icon-list-item-' + ( item.link && item.link.url ? 'with-link' : 'without-link' ),
							'elementor-repeater-item-' + item._id,
						]
					} );
					...
					if ( item.text != '' ) {
						...
						var text_html = '<' + textHTMLTag + ' ' + view.getRenderAttributeString( textKey ) + ' >' + text + '</' + textHTMLTag + '>';
