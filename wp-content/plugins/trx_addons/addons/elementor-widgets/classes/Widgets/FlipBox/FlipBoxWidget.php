...
class FlipBoxWidget extends BaseWidget {
	...
	protected function register_content_front_controls() {
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default'     => __( 'This is the content. Click edit button to change this text.', 'trx_addons' ),
			]
		);
	...
	protected function register_style_front_controls() {
		...
		// $this->add_responsive_control(
		// 	'description_elements_spacing_front',
		// 	[
		...
		// 		],
		// 		'selectors'             => [
		// 			'{{WRAPPER}} .trx-addons-flipbox-front .trx-addons-flipbox-content > :not(:last-child)' => 'margin-bottom: {{SIZE}}{{UNIT}};',
		// 		],
		// 	]
		// );
	...
	protected function register_style_back_controls() {
		...
		// $this->add_responsive_control(
		// 	'description_elements_spacing_back',
		// 	[
		// 		'label'                 => __( 'Elements Spacing', 'trx_addons' ),
		// 		'type'                  => Controls_Manager::SLIDER,
		// 		'size_units'            => [ 'px', '%', 'em', 'rem', 'vw', 'vh', 'custom' ],
		...
		// 		],
		// 		'selectors'             => [
		// 			'{{WRAPPER}} .trx-addons-flipbox-back .trx-addons-flipbox-content > :not(:last-child)' => 'margin-bottom: {{SIZE}}{{UNIT}};',
		// 		],
		// 	]
		// );
	...
	protected function render_front() {
		...
		$title_tag_front = TrxAddonsUtils::validate_html_tag( $settings['title_html_tag_front'] );
	...
	protected function render_back() {
		...
		$title_tag = TrxAddonsUtils::validate_html_tag( $settings['title_html_tag_back'] );
