		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .trx-addons-woo-products .trx-addons-woo-products-product-wrapper .trx-addons-woo-products-qv-btn svg' => 'fill: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .trx-addons-woo-products .trx-addons-woo-products-product-wrapper .trx-addons-woo-products-qv-btn:hover svg' => 'fill: {{VALUE}}',
				),
			)
		);
