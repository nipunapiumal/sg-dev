					...
					if (!empty($trx_addons_args['hover']) && $trx_addons_post_format != 'audio') {
						...
						if ($trx_addons_args['hover'] == 'zoomin') {
							...
							?><div class="trx_addons_hover_content">
								<a href="<?php echo !empty($trx_addons_link) ? esc_url($trx_addons_link) : '#'; ?>" class="trx_addons_hover_icon trx_addons_hover_icon_link"<?php if (!empty($trx_addons_args['link'])) echo trx_addons_external_links_target(); ?>></a>
				...
				if (!empty($trx_addons_image)) {
					...
					?>><?php
						...
						if (!empty($trx_addons_link)) {
							?><a href="<?php echo esc_url($trx_addons_link); ?>" aria-hidden="true"<?php if (!empty($trx_addons_args['link'])) echo trx_addons_external_links_target(); ?>><?php
						}
						if (empty($trx_addons_args['thumb_bg'])) {
