...
if (!function_exists('trx_addons_sc_widget_socials_add_in_vc_params')) {
	function trx_addons_sc_widget_socials_add_in_vc_params() {
		return apply_filters('trx_addons_sc_map', array(
				...
				"name" => esc_html__("Socials & Share", 'trx_addons'),
				"description" => wp_kses_data( __("Insert widget with social icons or share links, that specified in the Theme Options", 'trx_addons') ),
