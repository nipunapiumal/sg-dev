			...
			?>"><?php
				...
				if (empty($item['url'])) {
					...
					?><a class="custom_links_list_item_link" href="<?php echo esc_url($item['url']); ?>"<?php
						echo trx_addons_get_link_attributes( $item, 'url' );
						if (!empty($item['color'])) echo ' style="color:'.esc_attr($item['color']).' !important;"';
					?>><?php
				}
				// Image or Icon
				...
				if (!empty($item['url']) && !empty($item['caption'])) {
					?><a class="custom_links_list_item_button sc_button sc_button_simple" href="<?php echo esc_url($item['url']); ?>"<?php echo trx_addons_get_link_attributes( $item, 'url' ); ?>><?php
