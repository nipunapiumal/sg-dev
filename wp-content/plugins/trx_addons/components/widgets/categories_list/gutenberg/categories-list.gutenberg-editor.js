(function(blocks, i18n, element) {
	...
	blocks.registerBlockType(
		...
		trx_addons_apply_filters( 'trx_addons_gb_map', {
			title: __( 'ThemeREX Categories list', "trx_addons" ),
			description: __( "Insert categories list with icons or images", "trx_addons" ),
			keywords: [ 'categories', 'taxonomies', 'terms' ],
			icon: 'editor-ul',
						...
						'general_params': el( wp.element.Fragment, {},
							trx_addons_gutenberg_add_params( trx_addons_apply_filters( 'trx_addons_gb_map_add_params', [
								...
								// List of the terms
								{
									...
									'descr': __( "The comma separated list of the term slugs or IDs to show. If empty - show 'number' terms (see the field below)", "trx_addons" ),
									'type': 'text',
								},
