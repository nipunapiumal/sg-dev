	...
	?><div class="sc_form_field_wrap"><?php
		...
		if ( ! empty( $args['field_multiple'] ) && ! empty( $args['show_selected'] ) ) {
			?><div class="trx_addons_multiple_selected sc_form_field_items_selected">
				...
				<a href="#" role="button" class="sc_form_field_items_selected_clear"><?php esc_html_e( 'Clear all', 'trx_addons' ); ?></a>
				<a href="#" role="button" class="sc_form_field_items_selected_select_all"><?php esc_html_e( 'Select all', 'trx_addons' ); ?></a>
			</div><?php
		}
