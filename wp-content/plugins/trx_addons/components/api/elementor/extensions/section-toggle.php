...
if ( ! function_exists('trx_addons_elm_section_toggle_add_params' ) ) {
	...
	function trx_addons_elm_section_toggle_add_params( $element, $section_id, $args ) {
		...
		if ( ( $el_name == 'section' && $section_id == 'section_layout' ) || ( $el_name == 'container' && $section_id == 'section_layout_container' ) ) {
			...
			$element->add_control( 'trx_section_toggle', array(
				...
				'separator' => 'before',
				'label' => __( 'Toggle behaviour', 'trx_addons' ),	// . trx_addons_get_theme_doc_link( '#elementor_extension_section_toggle' ),
				'label_block' => false,
