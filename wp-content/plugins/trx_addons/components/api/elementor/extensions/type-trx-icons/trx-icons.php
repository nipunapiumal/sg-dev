...
class Trx_Addons_Elementor_Control_Trx_Icons extends \Elementor\Base_Data_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'trx_addons-elementor-control-trx-icons', trx_addons_get_file_url(TRX_ADDONS_PLUGIN_API . 'elementor/extensions/type-trx-icons/trx-icons-control.js'), array('jquery'), null, true );
	}
