		...
		return apply_filters('trx_addons_sc_map', array(
				...
				"params" => array_merge(
					array(
						...
						array(
							"param_name" => "past",
							"heading" => esc_html__("Events Time", 'trx_addons'),
							"description" => wp_kses_data( __("Show the all / past / upcoming events", 'trx_addons') ),
							'edit_field_class' => 'vc_col-sm-6',
							"admin_label" => true,
							"value" => array_flip( trx_addons_get_list_sc_events_time() ),
							"std" => '0',
							"type" => "dropdown"
						),
						array(
					...
					apply_filters( 'trx_addons_filter_add_title_param', true, 'trx_sc_events' ) ? trx_addons_vc_add_title_param() : array(),
