...
if (!function_exists('trx_addons_sc_socials_add_in_vc_params')) {
	function trx_addons_sc_socials_add_in_vc_params() {
		return apply_filters('trx_addons_sc_map', array(
				"base" => "trx_sc_socials",
				"name" => esc_html__("Custom Socials & Share", 'trx_addons'),
				"description" => wp_kses_data( __("Insert custom social icons with links on your profiles or share links", 'trx_addons') ),
				...
				"params" => array_merge(
					...
					apply_filters( 'trx_addons_filter_add_title_param', true, 'trx_sc_socials' ) ? trx_addons_vc_add_title_param() : array(),
