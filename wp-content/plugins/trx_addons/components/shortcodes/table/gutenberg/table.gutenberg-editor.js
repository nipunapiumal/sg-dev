	...
	blocks.registerBlockType(
		...
		trx_addons_apply_filters( 'trx_addons_gb_map', {
			...
			attributes: trx_addons_apply_filters( 'trx_addons_gb_map_get_params', trx_addons_object_merge(
				...
				! trx_addons_apply_filters( 'trx_addons_filter_add_title_param', true, 'trx-addons/table' ) ? {} : trx_addons_gutenberg_get_param_title(),
				! trx_addons_apply_filters( 'trx_addons_filter_add_title_param', true, 'trx-addons/table' ) ? {} : trx_addons_gutenberg_get_param_button(),
				...
				return trx_addons_gutenberg_block_params(
					{
						...
						'additional_params': el( wp.element.Fragment, { key: props.name + '-additional-params' },
							// Title params
							! trx_addons_apply_filters( 'trx_addons_filter_add_title_param', true, 'trx-addons/table' ) ? null : trx_addons_gutenberg_add_param_title( props, true ),
							// ID, Class, CSS params
