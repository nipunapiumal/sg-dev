	...
	function trx_addons_sc_table_add_in_elementor() {
		...
		class TRX_Addons_Elementor_Widget_Table extends TRX_Addons_Elementor_Widget {
			...
			protected function register_controls() {
				...
				$descr = sprintf( __('Replace this text with content, created with any table-generator, for example: %1$s or %2$s', 'trx_addons'),
							'http://www.impressivewebs.com/html-table-code-generator/',
