	...
	function trx_addons_sc_blogger_add_in_elementor() {
		...
		class TRX_Addons_Elementor_Widget_Blogger extends TRX_Addons_Elementor_Widget {
			...
			public function get_keywords() {
				return [ 'blog', 'posts', 'list', 'archive', 'slider', 'carousel' ];
			}
			...
			public function get_icon() {
				return 'eicon-image-box trx_addons_elementor_widget_icon';
			}
...
*/
				...
				$this->add_control(
					...
					[
						...
						'label_block' => false,
						'description' => sprintf( __( 'See available formats %s', 'trx_addons' ), '<a href="//wordpress.org/support/article/formatting-date-and-time/"' . trx_addons_external_links_target( true ) . '>' . __( 'here', 'trx_addons') . '</a>' ),
						'type' => \Elementor\Controls_Manager::TEXT,
						'default' => '',
						'condition' => [
							'type' => [ 'default', 'wide', 'list', 'news', 'cards' ],
				...
				$this->add_control(
					'disable_date_diff',
					[
						'label' => __( 'Disable human-readable date', 'trx_addons' ),
						'label_block' => false,
						'type' => \Elementor\Controls_Manager::SWITCHER,
