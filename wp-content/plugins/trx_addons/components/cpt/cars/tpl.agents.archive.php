<?php
/**
 * The template to display the car agents archive
 *
		...
		?>"><?php
			...
			while ( have_posts() ) { the_post(); 
				trx_addons_get_template_part(array(
												TRX_ADDONS_PLUGIN_CPT . 'cars/tpl.agents.' . trim( trx_addons_sanitize_file_name( $trx_addons_agents_type ) ).'-item.php',
