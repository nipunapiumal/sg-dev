...
if (have_posts()) {
		...
		?>"><?php
			...
			while ( have_posts() ) { the_post(); 
				trx_addons_get_template_part(array(
												TRX_ADDONS_PLUGIN_CPT . 'cars/tpl.cars.' . trim( trx_addons_sanitize_file_name( $trx_addons_cars_type ) ) . '-item.php',
	...
	trx_addons_get_template_part( apply_filters( 'trx_addons_filter_sc_cars_posts_none', 'templates/tpl.posts-none.php', $args ) );
