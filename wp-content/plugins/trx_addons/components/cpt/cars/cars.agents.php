...
if ( ! function_exists( 'trx_addons_cpt_cars_agents_init' ) ) {
	...
	/**
	 * Register the post type and corresponding taxonomies.
	 * Hook on the priority -1 to add our CPT before the 3rd-party plugins flushes rewrite rules
	 *
	 * @hooked 'init'
	 */
