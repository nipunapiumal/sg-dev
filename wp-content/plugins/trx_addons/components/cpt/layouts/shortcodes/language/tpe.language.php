...
var languages = JSON.parse('<?php
								$languages = apply_filters( 'wpml_active_languages', array(), 'skip_missing=' . (int)apply_filters( 'trx_addons_filter_wpml_languages_skip_missing', 1 ) );
...
_.each(languages, function(lang) {
	...
	lang_list += "\n"
				+ '<li class="menu-item' + (lang.active ? ' current-menu-item' : '') + '">'
					+ '<a rel="alternate" hreflang="' + lang.language_code + '" href="#" role="button">'
