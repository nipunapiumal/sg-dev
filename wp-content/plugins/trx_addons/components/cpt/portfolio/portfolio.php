...
if ( ! function_exists( 'trx_addons_cpt_portfolio_init' ) ) {
	...
	function trx_addons_cpt_portfolio_init() {
		...
		trx_addons_meta_box_register(TRX_ADDONS_CPT_PORTFOLIO_PT, array(
			...
			"button_link_hide_in_archive" => array(
				"title" => esc_html__("Hide on archive page",  'trx_addons'),
				"desc" => wp_kses_data( __("Don't show this button on the Portfolio archive page.", 'trx_addons') ),
				"std" => "0",
				"type" => "switch"
			),
