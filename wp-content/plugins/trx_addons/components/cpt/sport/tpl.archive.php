		...
		?>"><?php
			...
			while ( have_posts() ) { the_post(); 
				trx_addons_get_template_part(array(
												TRX_ADDONS_PLUGIN_CPT . 'sport/tpl.' . trim( trx_addons_sanitize_file_name( $trx_addons_slug ) ) . '.' . trim( trx_addons_sanitize_file_name( $trx_addons_type ) ) . '-item.php',
												TRX_ADDONS_PLUGIN_CPT . 'sport/tpl.' . trim( trx_addons_sanitize_file_name( $trx_addons_slug ) ) . '.archive-item.php',
