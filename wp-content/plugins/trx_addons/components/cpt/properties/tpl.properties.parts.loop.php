...
if (have_posts()) {
		...
		?>"><?php
			...
			while ( have_posts() ) { the_post(); 
				trx_addons_get_template_part(array(
												TRX_ADDONS_PLUGIN_CPT . 'properties/tpl.properties.' . trim( trx_addons_sanitize_file_name( $trx_addons_properties_type ) ) . '-item.php',
	...
	trx_addons_get_template_part( apply_filters( 'trx_addons_filter_sc_properties_posts_none', 'templates/tpl.posts-none.php', $args ) );
