		...
		if (trx_addons_reviews_enable()) {
			trx_addons_array_insert_before($options, 'sc_section', array(
				...
				'reviews_section_info' => array(
					"title" => esc_html__('Reviews settings', 'trx_addons') . trx_addons_get_theme_doc_link( '#themerex_addons_reviews' ),
...
if (!function_exists('trx_addons_reviews_sc_load')) {
	add_action( 'after_setup_theme', 'trx_addons_reviews_sc_load', 6 );
	function trx_addons_reviews_sc_load() {
